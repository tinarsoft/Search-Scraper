...
const LINK_SELECTOR = "#links a.result__a";
const NEXT_SELECTOR = "a.result--more__btn";
const ENGINE = Path.basename(__filename, ".js");
const PERSIST_NAME = "sec-" + ENGINE;
const SEARCH_TEXTBOX_SELECTOR = 'form[name="x"] input[name="q"]';
const SEARCH_SUBMIT_SELECTOR = 'form[name="x"] input[type="submit"]';
const NOT_FOUND_STR = "(No results)|(We did not find results for)|(did not match any document)|(No results found)|(hiçbir arama sonucu mevcut değil)|(hiçbir sonuç bulunamadı)|(not find results)|(No results for)";
