...
const SEARCH_ENGINE_URL = "https://www.google.com";
const COUNT_SELECTOR = "#resultStats";
const LINK_SELECTOR = "#main div.med div.g div.rc h3.r a";
const NEXT_SELECTOR = "#pnnext";
const ENGINE = Path.basename(__filename, ".js");
const PERSIST_NAME = "sec-" + ENGINE;
const SEARCH_TEXTBOX_SELECTOR = 'form[action="/search"] [name=q]';
const SEARCH_SUBMIT_SELECTOR = 'form[action="/search"] input[name="btnK"]';
