...
const SEARCH_ENGINE_URL = "https://search.yahoo.com/";
const COUNT_SELECTOR = "none";
const LINK_SELECTOR = "#web h3.title a";
const NEXT_SELECTOR = ".compPagination a.next";
const ENGINE = Path.basename(__filename, ".js");
const PERSIST_NAME = "sec-" + ENGINE;
const SEARCH_TEXTBOX_SELECTOR = 'form[name="s"] input[name="p"]';
const SEARCH_SUBMIT_SELECTOR = 'form[name="s"] button[type="submit"]';
const NOT_FOUND_STR = "(We did not find results for)|(did not match any document)|(No results found)|(hiçbir arama sonucu mevcut değil)|(hiçbir sonuç bulunamadı)|(not find results)|(No results for)";
