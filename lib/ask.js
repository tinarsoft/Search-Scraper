...
const SEARCH_ENGINE_URL = "https://www.ask.com/";
const COUNT_SELECTOR = "none";
const LINK_SELECTOR = ".PartialSearchResults-body a.result-link";
const NEXT_SELECTOR = ".PartialWebPagination-next";
const ENGINE = Path.basename(__filename, ".js");
const PERSIST_NAME = "sec-" + ENGINE;
const SEARCH_TEXTBOX_SELECTOR = "input.search-box-input";
const SEARCH_SUBMIT_SELECTOR = 'form[action="/web"] button[type=submit]';
const NOT_FOUND_STR = "(did not match any document)|(No results found)|(hiçbir arama sonucu mevcut değil)|(hiçbir sonuç bulunamadı)|(not find results)|(No results for)";
