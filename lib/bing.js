...
const SEARCH_ENGINE_URL = "https://www.bing.com";
const COUNT_SELECTOR = "span.sb_count";
const LINK_SELECTOR = ".b_algo h2 a";
const NEXT_SELECTOR = "a.sb_pagN";
const ENGINE = Path.basename(__filename, ".js");
const PERSIST_NAME = "sec-" + ENGINE;
const SEARCH_TEXTBOX_SELECTOR = "#sb_form_q";
const SEARCH_SUBMIT_SELECTOR = "#sb_form_go";
